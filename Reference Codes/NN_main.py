...
data_list = np.stack([healthy_LF, healthy_SS, leak_LF, leak_SS, actuator_LF, actuator_SS])
# data_ID   = ['healthy_LF', 'healthy_SS', 'leak_LF', 'leak_SS', 'actuator_LF', 'actuator_SS']
data_ID   = ['Healthy LF', 'Healthy SS', 'Leak LF', 'Leak SS', 'Actuator LF', 'Actuator SS']
