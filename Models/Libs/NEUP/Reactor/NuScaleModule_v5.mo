...
model NuScaleModule_v5
  ...
  Modelica.Blocks.Interfaces.RealOutput SG_press
    annotation (Placement(transformation(extent={{44,80},{54,90}}),
        iconTransformation(extent={{44,80},{54,90}})));
equation
  ...
  connect(port_b, massFlowRate1.port_a) annotation (Line(points={{71,-131},{71,
          -74},{68,-74},{68,-71},{62,-71}},
                                    color={0,127,255}));
  connect(realExpression6.y, SG_press)
    annotation (Line(points={{61,82},{61,85},{49,85}},
                                                   color={0,0,127}));
