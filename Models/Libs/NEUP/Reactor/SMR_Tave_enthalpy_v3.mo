within NEUP.Reactor;
model SMR_Tave_enthalpy_v3

  extends
    NHES.Systems.PrimaryHeatSystem.SMR_Generic.BaseClasses.Partial_SubSystem_A(
    replaceable package Medium = Modelica.Media.Water.StandardWater,
    allowFlowReversal=system.allowFlowReversal,
    redeclare replaceable NHES.Systems.PrimaryHeatSystem.SMR_Generic.CS_Dummy
      CS,
    redeclare replaceable NHES.Systems.PrimaryHeatSystem.SMR_Generic.ED_Dummy
      ED,
    redeclare
      NHES.Systems.PrimaryHeatSystem.SMR_Generic.Components.Data.Data_GenericModule_SMR
      data,
...
Real Tave=(Tcore_inlet.T+Tcore_exit.T)/2.0;
  ...
  NHES.Systems.PrimaryHeatSystem.SMR_Generic.Components.Data.DataInitial dataInitial(
