...
equation
  ...
  connect(TCV2.port_a, volume.port_b)
    annotation (Line(points={{-224,32},{-308,32}}, color={0,127,255}));
  connect(TCV1.port_a, volume.port_b) annotation (Line(points={{-228,146},{-294,
          146},{-294,32},{-308,32}}, color={0,127,255}));
  connect(volume.port_b, TCV3.port_a) annotation (Line(points={{-308,32},{-294,
          32},{-294,-108},{-224,-108}},
                                    color={0,127,255}));
  ...
  connect(no_mult.y, PID_prod.u1)
    annotation (Line(points={{-267.2,-92},{-257.4,-92},{-257.4,-93.2}},
                                                         color={0,0,127}));
