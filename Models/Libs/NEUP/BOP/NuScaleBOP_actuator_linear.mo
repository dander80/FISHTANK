within NEUP.BOP;
model NuScaleBOP_actuator_linear
  ...
  Modelica.Blocks.Sources.Ramp ramp(
    ...
    duration=1.0e6,
    offset=1,
    startTime=0.2e6) annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=90,
        origin={-296,-6})));
equation
  ...
  connect(ramp.y, PID_prod.u1) annotation (Line(points={{-296,5},{-296,38.8},{
          -289.4,38.8}}, color={0,0,127}));
  annotation (Icon(coordinateSystem(preserveAspectRatio=false, extent={{-340,
        ...
        coordinateSystem(preserveAspectRatio=false, extent={{-340,-120},{220,
            140}})));
end NuScaleBOP_actuator_linear;
