...
model Plant_FMU_edit
  Reactor.NuScaleModule_v5 nuScaleModule_v5_1(PressurizerandTopper(port_b(
    ...
    annotation (Placement(transformation(extent={{-86,-52},{-42,4}})));
  ...
  Modelica.Blocks.Sources.TimeTable training_data(table=[0,1; 86400,1; 108000,1;
        ...
        1081200,0.80; 1082400,1; 1123200,1; 1209600,1; 1.31e6,0.8; 2e6,0.8;
        2.1e6,1.0; 2.2e6,1.0; 2.3e6,0.9; 2.8e6,0.9; 2.85e6,1.0; 10e6,1.0],
      nextEvent(start=86400.0))
...
equation
  connect(p_Control.y, nuScaleModule_v5_1.CR_reactivity) annotation (Line(
        points={{-123,4},{-102,4},{-102,-10},{-71.15,-10},{-71.15,-7.2}},
                                                              color={0,0,127}));
  connect(nuScaleModule_v5_1.Core_Tavg, p_Control.u_m) annotation (Line(
        points={{-70.7375,-12.1538},{-70.7375,-18},{-134,-18},{-134,-8}},
                                                                       color=
          {0,0,127}));
  ...
  connect(nuScaleModule_v5_1.port_a, BOP_mdot.port_a) annotation (Line(points={{
          -51.4875,-16.4615},{-51.4875,-20},{2,-20},{2,-18.32},{59.2765,-18.32}},
        color={0,127,255}));
  connect(nuScaleModule_v5_1.port_b, BOP_mdot.port_b) annotation (Line(points={{
          -51.4875,-50.0615},{-51.4875,-50},{58.7294,-50},{58.7294,-52.64}},
        color={0,127,255}));
  ...
  connect(switch2.u3, BOP_mdot.W_Sensor) annotation (Line(points={{10.4,-107.6},
          {10.4,-70},{74,-70},{74,-50},{73.8647,-50},{73.8647,-50.3}},
                                                       color={0,0,127}));
  ...
  connect(switch1.u3, nuScaleModule_v5_1.SG_press) annotation (Line(points={{-4.4,
          47.6},{-54.5125,47.6},{-54.5125,-3.53846}},      color={0,0,127}));
  ...
  connect(training_data.y, product2.u1) annotation (Line(points={{-141.4,-48},{
          -92,-48},{-92,-85.2},{-79.6,-85.2}}, color={0,0,127}));
