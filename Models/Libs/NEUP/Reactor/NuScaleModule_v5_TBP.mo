...
model NuScaleModule_v5_TBP
  ...
  Modelica.Blocks.Interfaces.RealInput CR_reactivity
    annotation (Placement(transformation(extent={{-100,38},{-60,78}}),
        iconTransformation(extent={{-58,58},{-78,78}})));
  ...
  Modelica.Blocks.Sources.RealExpression SG_exit_enth(y=SG_exit_enth.y)
    annotation (Placement(transformation(extent={{-34,-198},{-14,-178}})));
  Modelica.Blocks.Interfaces.RealOutput SG_enth annotation (Placement(
        transformation(extent={{52,-200},{30,-178}}), iconTransformation(extent=
           {{30,-200},{52,-178}})));
  Modelica.Blocks.Sources.RealExpression Reactor_Power(y=core.Q_total.y)
    annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=-90,
        origin={120,-50})));
  Modelica.Blocks.Interfaces.RealOutput RxT_Power annotation (Placement(
        transformation(
        extent={{-10,-10},{10,10}},
        rotation=-90,
        origin={120,-96}), iconTransformation(
        extent={{-10,-10},{10,10}},
        rotation=-90,
        origin={-90,-128})));
equation
  ...
  connect(Reactor_Power.y, RxT_Power)
    annotation (Line(points={{120,-61},{120,-96}}, color={0,0,127}));
  connect(SG_exit_enth.y, SG_enth) annotation (Line(points={{-13,-188},{41,-188},
          {41,-189}}, color={0,0,127}));
  annotation (Icon(coordinateSystem(preserveAspectRatio=false, extent={{-180,
            -140},{140,120}}), graphics={Bitmap(extent={{-152,-350},{140,342}},
