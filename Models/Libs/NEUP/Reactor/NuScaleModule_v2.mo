...
model NuScaleModule_v2
  ...
  TRANSFORM.Fluid.BoundaryConditions.MassFlowSource_h Inlet(
    redeclare package Medium = Modelica.Media.Water.StandardWater,
...
equation
  ...
  connect(Inlet.ports[1], massFlowRate1.port_a) annotation (Line(points={{116,
          -82},{98,-82},{98,-71},{78,-71}}, color={0,127,255}));
